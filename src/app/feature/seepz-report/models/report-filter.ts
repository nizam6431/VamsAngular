...
export enum seepz_report_type {
    Personal_permanent_report = "Personal_permanent_report",
    Vehicle_permanent_report = "Vehicle_permanent_report",
    daily_pass_report = "daily_pass_report"
