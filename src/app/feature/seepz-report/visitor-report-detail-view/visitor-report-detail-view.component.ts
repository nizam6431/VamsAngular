...
import { SeepzVisitorReportDetails, VisitorReportDetails } from '../../reports/models/report_details';
import { DetailsPageService } from '../../reports/services/details-page.service'
...
@Component({
  selector: 'app-visitor-report-detail-view',
  templateUrl: './visitor-report-detail-view.component.html',
  styleUrls: ['./visitor-report-detail-view.component.scss']
})
export class VisitorReportDetailViewComponent implements OnInit {

  reportDetails = Object(SeepzVisitorReportDetails);
  reportDetailsKeys = Object.keys(SeepzVisitorReportDetails);
  reportData = {};
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<VisitorReportDetailViewComponent>,
