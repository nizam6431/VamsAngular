...
@Component({
  selector: 'app-walkin-visitor-checkout',
  templateUrl: './walkin-visitor-checkout.component.html',
  styleUrls: ['./walkin-visitor-checkout.component.scss']
})
export class WalkinVisitorCheckoutComponent implements OnInit {
  @Input() columns;
  displayColumns :any;
