...
@Component({
  selector: 'app-privacy-policy-visitor',
  templateUrl: './privacy-policy-visitor.component.html',
  styleUrls: ['./privacy-policy-visitor.component.scss']
})
export class PrivacyPolicyVisitorComponent implements OnInit {
  @Output() fileUpload = new EventEmitter();
  uploadFileForm: FormGroup;
  doc: any = "";
  @Input() privacyUploadVisitorFile;
  private validationMessages: { [key: string]: { [key: string]: string } };
  @ViewChild('inputFile') myInputVariable: ElementRef;
  level2Id: number = null;
  file: any;
  userDetails: any;
  docType: string = documentType.visitorPrivacyPolicy
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (this.privacyUploadVisitorFile) {
      this.uploadPdf();
    }
  }
  uploadPdf() {
