...
import { base64ToBufferAsync, PrintPDF, printPdf, resizeImage, _base64ToArrayBuffer } from 'src/app/core/functions/functions';

@Component({
  selector: 'app-preschedule',
  templateUrl: './preschedule.component.html',
  styleUrls: ['./preschedule.component.css']
})
export class PrescheduleComponent implements OnInit, OnDestroy {
  ...
  constructor(private formBuilder: FormBuilder,
    public dialogRef: MatDialogRef<PrescheduleComponent>,
